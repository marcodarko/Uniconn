...
// //	var sparkText = ['&#9679;', '&#9679;', '&#9679;', '&#9679;'];
// 	var sparkCss = [
// 					{color: 'lightpink', display: 'inline-Block', cursor: 'default'},
// 					{color: 'lightblue', display: 'inline-Block', cursor: 'default'},
// 					{color: 'lightyellow', display: 'inline-Block', cursor: 'default'},
// 					{color: 'white', display: 'inline-Block', cursor: 'default'}
// 					];
...
// 	sparks = sparks || ['&#9733;', '&#9733;', '&#9733;', '&#9733;', '&#9733;'];
// 	sparkCss = sparkCss || [
// 					{color: 'lightyellowy', display: 'inline-Block', cursor: 'default'},
// 					{color: 'lightblue', display: 'inline-Block', cursor: 'default'},
// 					{color: 'lightpink', display: 'inline-Block', cursor: 'default'},
// 					{color: 'hotpink', display: 'inline-Block', cursor: 'default'},
// 					{color: 'white', display: 'inline-Block', cursor: 'default'}
// 					];
// 	target = target || 'body';
