...
export default class ResultItem extends React.Component {
  ...
  render() {
    return (
      ...
      {this.props.status === 'online'? <span title='online' style={{color:'#b6fc5e'}} className="glyphicon glyphicon-ice-lolly" aria-hidden="true"></span> : <span title='offline' style={{color:'#fa4d76'}} className="glyphicon glyphicon-ice-lolly-tasted" aria-hidden="true"></span>}
          {!this.state.showDetails && <div className="resultGradientBox">         
            ...
            <p className="whiteText"><strong>{this.props.relationship || "Ask Him"}</strong></p>
          </div>}
          {this.state.showDetails && <div className="resultGradientBox2">
            ...
            <p className="whiteText">Status: <b>{this.props.relationship || "N/A"}</b></p>
            ...
            <p className="whiteText" style={{fontSize:'12px'}}>{this.props.description || "Oops! Looks like he forgot to fill this out!"}</p>
          </div>}
        </div>
      </div>
    );
